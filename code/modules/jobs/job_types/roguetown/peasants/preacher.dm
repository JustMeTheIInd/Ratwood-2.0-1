/datum/job/roguetown/preacher
	...
	tutorial = "Settled Pilgrim, Otavan Agent or a man that could turn mountains with his charisma? It matters naught, for yils now you dutifully and faithfully served as the lone voice for the All-Father. ENDURING the many insults and jokes at your and your God's expense, the repeated attempts by the local Tennite Clergy to shut down your Holy Temple and have you be cast into iron chain... Now, after yils of holy servitude you find yourself the loudest voice for the Pilgrims and even the local Village. Stand tall, O' Child of SYON, Hold fast to your oaths, Preach the word of the FATHER, and, above all else, ENDURE, AS HE DOES..."
...
/datum/outfit/job/roguetown/preacher
	...
	backpack_contents = list(obj/item/roguekey/psychurch = 1, /obj/item/needle/thorn = 1, /obj/item/book/rogue/bibble/psy = 1)

/datum/advclass/preacher/adherent // Otavan Spy. Gets blood magic, silver cross and a sword. Still not really geared for combat. 
	name = "Adherent"
	tutorial = "Trained in the cold mountains of Holy Otava, you were sent to Teuval to gain trust and keep watch over these hallowed lands, The locals admire you for your miracle-work, and beautiful silver ornaments... They need not know where from it all really comes."
