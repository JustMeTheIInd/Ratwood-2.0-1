/obj/structure/fluff/walldeco/sanitarium
	...
	icon = 'modular_teuval/icons/decoration.dmi'

/obj/structure/fluff/walldeco/psybanner/scarlet
	name = "Scarlet Psydonite Banner"
	icon_state = "psybanner_scarlet"
	desc = "A proud and vibrant, banner depicting a pure-white psy-cross upon the backdrop of blood-red scarlet. As HE bleeds for US, so shall WE bleed for HIM."
	icon = 'modular_teuval/icons/decoration.dmi'
...
/obj/structure/fluff/walldeco/psybanner/tennite/noc
	...
	icon = 'modular_teuval/icons/decoration.dmi'
	desc = "A banner of gleaming, deep blue, color most often associated with Noc, and his many blessings towards knowledge and the arcyne."

/obj/structure/fluff/walldeco/psybanner/tennite/necra
	name = "Necran Banner"
	icon_state = "necrabanner"
	icon = 'modular_teuval/icons/decoration.dmi'
	desc = "Banner grey like the ashes of the Underworld. Necra awaits.."
